...
O objetivo deste projeto foi realizar uma análise estatística utilizando uma base de dados real relacionada ao mercado de veículos elétricos. A atividade teve como foco a identificação e classificação de variáveis estatísticas, além da construção de tabelas de distribuição de frequências utilizando a linguagem Python.
A análise busca compreender padrões presentes nos dados e demonstrar como informações estatísticas podem auxiliar na tomada de decisão e na geração de valor para empresas do setor automotivo e de mobilidade sustentável.
...
Foi realizada uma tabela de distribuição de frequência utilizando a variável Electric Range.
...
Base pública de veículos elétricos utilizada para fins acadêmicos e estatísticos.
